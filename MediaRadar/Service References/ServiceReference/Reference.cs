...
namespace MediaRadar.ServiceReference {
    ...
    public partial class Ad : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private MediaRadar.ServiceReference.Brand BrandField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public MediaRadar.ServiceReference.Brand Brand {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReference.IAdDataService")]
    public interface IAdDataService {
        ...
        MediaRadar.ServiceReference.Ad[] GetAdDataByDateRange(System.DateTime startDate, System.DateTime endDate);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAdDataService/GetAdDataByDateRange", ReplyAction="http://tempuri.org/IAdDataService/GetAdDataByDateRangeResponse")]
        System.Threading.Tasks.Task<MediaRadar.ServiceReference.Ad[]> GetAdDataByDateRangeAsync(System.DateTime startDate, System.DateTime endDate);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAdDataServiceChannel : MediaRadar.ServiceReference.IAdDataService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AdDataServiceClient : System.ServiceModel.ClientBase<MediaRadar.ServiceReference.IAdDataService>, MediaRadar.ServiceReference.IAdDataService {
        ...
        public MediaRadar.ServiceReference.Ad[] GetAdDataByDateRange(System.DateTime startDate, System.DateTime endDate) {
            return base.Channel.GetAdDataByDateRange(startDate, endDate);
        }
        
        public System.Threading.Tasks.Task<MediaRadar.ServiceReference.Ad[]> GetAdDataByDateRangeAsync(System.DateTime startDate, System.DateTime endDate) {
